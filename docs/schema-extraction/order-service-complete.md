# COMPLETE DATABASE ANALYSIS: order-service
...
### All JOIN operations:
backend/services/order-service//src/index.js:11:const ServiceBootstrap = require(path.join(__dirname, '../../../shared/src/service-bootstrap'));
