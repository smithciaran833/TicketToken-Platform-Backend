...
class DistributedTracingService extends EventEmitter {
   ...
   * Start a new span
   */
  startSpan(operationName: string, parentSpanId?: string, tags?: Record<string, any>): Span {
...
export function tracingMiddleware() {
  return (req: any, res: any, next: any) => {
    ...
    const span = distributedTracing.startSpan(`${req.method} ${req.path}`, context.parentSpanId, {
