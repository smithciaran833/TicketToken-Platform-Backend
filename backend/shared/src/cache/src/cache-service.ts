...
export class CacheService {
  ...
  private getTTLForKey(key: string): number {
    ...
    switch (entity) {
      case 'session':
        return this.config.ttls.session;
      case 'user':
        return this.config.ttls.user;
      case 'event':
        return this.config.ttls.event;
      case 'venue':
        return this.config.ttls.venue;
      case 'ticket':
        return this.config.ttls.ticket;
      case 'template':
        return this.config.ttls.template;
      case 'search':
        return this.config.ttls.search;
      default:
