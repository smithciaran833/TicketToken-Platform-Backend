/**
 * Internal Auth Middleware (New) - analytics-service
 *
 ...
 *
 * Note: This replaces the legacy internal-auth.ts middleware when USE_NEW_HMAC=true
 */
...
const ALLOWED_SERVICES = new Set(
  (process.env.ALLOWED_INTERNAL_SERVICES || 'api-gateway,event-service,ticket-service,order-service,notification-service,payment-service')
    .split(',')
 ...
 */
export async function registerInternalAuthNew(fastify: FastifyInstance): Promise<void> {
  fastify.decorateRequest('internalServiceNew', null);
}
