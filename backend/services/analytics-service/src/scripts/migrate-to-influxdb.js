...
const metrics_migration_service_1 = require("../services/metrics-migration.service");
async function main() {
    const migrationService = new metrics_migration_service_1.MetricsMigrationService();
...
//# sourceMappingURL=migrate-to-influxdb.js.map