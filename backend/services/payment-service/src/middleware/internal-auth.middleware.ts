/**
 * Internal Auth Middleware (New) - payment-service
 *
...
const ALLOWED_SERVICES = new Set(
  (process.env.ALLOWED_INTERNAL_SERVICES || 'order-service,ticket-service,event-service,venue-service,marketplace-service,queue-service,notification-service')
    .split(',')
