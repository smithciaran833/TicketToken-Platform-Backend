...
export class ProgramEventListener extends BaseListener {
  ...
  async processLogs(logs: LogsContext): Promise<void> {
    try {
  ...
  async processEvent(event: LogEvent, signature: string): Promise<void> {
  ...
  async handleTicketMinted(data: any, signature: string): Promise<void> {
  ...
  async handleTicketTransferred(data: any, signature: string): Promise<void> {
    console.log('Ticket transferred event:', data);
    // Record transfer in database
  }

  async handleTicketUsed(data: any, signature: string): Promise<void> {
    console.log('Ticket used event:', data);
    // Mark ticket as used
  }

  async storeRawLogs(logs: LogsContext): Promise<void> {
