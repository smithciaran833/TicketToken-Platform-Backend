/**
 * Internal Auth Middleware (New) - blockchain-indexer
 *
...
const ALLOWED_SERVICES = new Set(
  (process.env.ALLOWED_INTERNAL_SERVICES || 'ticket-service,payment-service,marketplace-service,order-service,minting-service,blockchain-service,api-gateway')
    .split(',')
