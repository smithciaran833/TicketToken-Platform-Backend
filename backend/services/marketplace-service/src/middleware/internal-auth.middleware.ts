/**
 * Internal Auth Middleware - marketplace-service
 *
...
const ALLOWED_SERVICES = new Set(
  (process.env.ALLOWED_INTERNAL_SERVICES || 'api-gateway,payment-service,ticket-service,order-service,minting-service,transfer-service,blockchain-service,notification-service,event-service,analytics-service')
    .split(',')
