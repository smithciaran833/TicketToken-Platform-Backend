  ...
  describe('changePassword', () => {
    ...
    it('should invalidate all sessions after password change', async () => {
      ...
      await testPool.query(
        `INSERT INTO user_sessions (id, user_id, started_at) VALUES ($1, $2, NOW())`,
        ['aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', user.id]
      );
      await testPool.query(
        `INSERT INTO user_sessions (id, user_id, started_at) VALUES ($1, $2, NOW())`,
        ['bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', user.id]
      );
